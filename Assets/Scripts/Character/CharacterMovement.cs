...
public class CharacterMovement : MonoBehaviour 
{
    ...
    public float MaxSpeed { get { return isRunning ? runSpeed : walkSpeed; } }
    public float AnimSpeed { get { return HasPath ? currentSpeed / runSpeed : 0; } }
    ...
    private void createPath(List<Vector3> nodes, bool showMarker) 
    {
        ...
        if (showMarker) Instantiate(moveMarkerPrefab, nodes.Last(), Quaternion.identity);
    }
    ...
    public void SetSpeaking(Character character) 
    {
        ...
        if(characterSpeaking != null) StopMoving();
    }
